...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(UserRepository userRepository, FacebookService facebookService, BCryptPasswordEncoder encoder) {
    ...
    @Override
    public Optional<User> getByFacebookId(String userId) {
